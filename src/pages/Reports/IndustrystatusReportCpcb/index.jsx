...
const IndustrystatusReportCpcb = () => {
  ...
  const [stateBtnTxt, setStateBtnTxt] = useState("");
    ...
    (async () => {
      try {
        const result = await axios(
          ...
          }&searchStr=${searchStr}&show_to_CPCB=true&status_CPCB=${btnTxt.toLowerCase()}&state=${stateBtnTxt}&`
        );
